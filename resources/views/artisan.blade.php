<script require="@dcat-admin.helps">
$(function () {
...
<div class="box box-primary">
    ...
    <!-- /.chat -->
    <div class="box-footer with-border" style="display: block;">
        ...
        <div style="margin-bottom: 10px;">
            ...
            <div class="btn-group dropup">
                ...
                <ul style="max-height:400px;overflow: auto;padding:0;">
                        @foreach($command as $item)
                        <li class="dropdown-item"><a href="#" class="loaded-command">{{$item}}</a></li>
                        @endforeach
                    </ul>
                </div>
            </div>
        ...
        <div class="input-group">
            <span class="input-group-addon" style="font-size: 18px; width: 80px;border-right: 0;">artisan</span>
